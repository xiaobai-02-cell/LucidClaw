...
from lucidclaw.core.tools.builtins import (
    get_current_time,
    calculator
)
from lucidclaw.core.config import MEMORY_DIR, TASKS_FILE
...
class TestBuiltInTools(unittest.TestCase):
    ...
    @patch('lucidclaw.core.tools.builtins.MEMORY_DIR', new_callable=lambda: tempfile.mkdtemp())
    @patch('lucidclaw.core.tools.builtins.PROFILE_PATH', new_callable=lambda: tempfile.mktemp())
    def test_save_user_profile(self, mock_profile_path, mock_memory_dir):
        """测试保存用户档案功能"""
        from lucidclaw.core.tools.builtins import save_user_profile
...
class TestScheduledTasks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import lucidclaw.core.tools.builtins
        lucidclaw.core.tools.builtins.TASKS_FILE = self.temp_file.name
    ...
    def tearDown(self):
        ...
        # 恢复原始路径
        import lucidclaw.core.tools.builtins
        lucidclaw.core.tools.builtins.TASKS_FILE = self.original_tasks_file

    def test_schedule_task_single(self):
        """测试单次任务调度功能"""
        from lucidclaw.core.tools.builtins import schedule_task, list_scheduled_tasks
    ...
    def test_schedule_task_invalid_time_format(self):
        """测试调度任务 - 无效时间格式"""
        from lucidclaw.core.tools.builtins import schedule_task
    ...
    def test_list_scheduled_tasks_empty(self):
        """测试列出空任务列表"""
        from lucidclaw.core.tools.builtins import list_scheduled_tasks
    ...
    def test_get_system_model_info(self):
        """测试获取系统模型信息功能"""
        from lucidclaw.core.tools.builtins import get_system_model_info
...
class TestScheduledTasksWithTasks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original_tasks_file = TASKS_FILE
        import lucidclaw.core.tools.builtins
        lucidclaw.core.tools.builtins.TASKS_FILE = self.temp_tasks_file.name
    ...
    def test_delete_scheduled_task(self):
        """测试删除计划任务"""
        from lucidclaw.core.tools.builtins import delete_scheduled_task, list_scheduled_tasks
    ...
    def test_delete_nonexistent_task(self):
        """测试删除不存在的任务"""
        from lucidclaw.core.tools.builtins import delete_scheduled_task
    ...
    def test_modify_scheduled_task(self):
        """测试修改计划任务"""
        from lucidclaw.core.tools.builtins import modify_scheduled_task, list_scheduled_tasks
    ...
    def test_modify_scheduled_task_invalid_time(self):
        """测试修改计划任务 - 无效时间格式"""
        from lucidclaw.core.tools.builtins import modify_scheduled_task
