...
from lucidclaw.core.tools.sandbox_tools import (
    list_office_files,
    read_office_file,
    write_office_file,
...
from lucidclaw.core.config import OFFICE_DIR
...
class TestSandboxTools(unittest.TestCase):
    ...
    @patch('lucidclaw.core.tools.sandbox_tools.os.path.exists', return_value=True)
    @patch('lucidclaw.core.tools.sandbox_tools.os.listdir', return_value=['file1.txt', 'subdir'])
    @patch('lucidclaw.core.tools.sandbox_tools.os.path.isdir', side_effect=lambda x: x.endswith('subdir'))
    ...
    @patch('lucidclaw.core.tools.sandbox_tools.os.path.exists', return_value=False)
    ...
    @patch('lucidclaw.core.tools.sandbox_tools.subprocess.run')
